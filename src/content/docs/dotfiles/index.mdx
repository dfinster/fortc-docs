...
sidebar:
  label: Overview
description: A project that manages personal dotfiles
---
This is my customized version of [`getantidote/zdotdir`](https://github.com/getantidote/zdotdir), extended to manage other personal dotfiles in addition to Zsh configuration.
